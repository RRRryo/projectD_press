...
<head>
    ...
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags --><!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]--><title>X express</title>
<!-- Bootstrap -->
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav" style="width: 80%;">
                    ...
                    <li class="active dropdown" <%--style="width: 20%;  text-align: center;"--%>>
                    ...
                    </li>                <li class="dropdown" <%--style="width: 20%;  text-align: center;"--%>><a href="#">网上商城</a></li>
                    <%--<li><a href="#">会员登录</a></li>--%>            </ul>
